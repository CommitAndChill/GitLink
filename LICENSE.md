GitLink License (Version 1.0)
=============================

**SPDX-License-Identifier: GitLink-1.0**\
**Copyright (c) 2025 GitLink Contributors**
...
Subject to the terms and conditions of this License, GitLink Contributors hereby grants You a worldwide, royalty-free, non-exclusive, irrevocable license to:
...
1.  **Attribution:** You must include the following notice in all copies or substantial portions of the Software, including modified versions:
    ...
    `Licensed under the GitLink License, Copyright (c) GitLink Contributors.
...
The Software includes libgit2 in the `Source/ThirdParty/libgit2` directory.
libgit2 is licensed under the GPLv2 with a linking exception, and is **not covered by the GitLink License**.
Users must comply with the terms of the libgit2 license when using or distributing those components.
